            ...
            <div className="container mx-auto px-4 py-20 max-w-7xl">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredResources.map((resource, idx) => (
                        <Reveal key={resource.id} delay={Math.min(idx * 0.05, 0.25)}>
                            <Card className="group flex flex-col rounded-[2.5rem] border-none shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden bg-background">
                ...
                <Reveal className="mt-24">
                  <section className="p-12 lg:p-20 rounded-[3.5rem] bg-primary text-primary-foreground relative overflow-hidden shadow-2xl shadow-primary/20">
