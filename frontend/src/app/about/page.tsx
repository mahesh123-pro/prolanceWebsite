    ...
    return (
        <div className="container mx-auto px-4 py-20 max-w-4xl min-h-screen">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
                <div className="bg-muted/30 border border-border/50 rounded-3xl p-8 md:p-12 mb-12 shadow-sm">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8 md:p-12 mb-12 shadow-sm">
